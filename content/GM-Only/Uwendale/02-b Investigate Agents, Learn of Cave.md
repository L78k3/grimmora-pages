...
- Primary: Identify and confront the enemy agents; gather intelligence about their plans.
- Secondary: Avoid escalation into open conflict (if possible); recover evidence or intercept coded messages; determine the fate of the missing villagers.
...
- Stealth or negotiation: Avoiding patrols, eavesdropping on enemy conversations, or parleying with hostile agents.
- Skill challenge: Deciphering coded messages, following tracks, or piecing together evidence of the cave’s location.
- Risk of escalation: If discovered, the party may face a skirmish or have to escape pursuit.

## Clues & Rewards

- Clues: Coded messages, a map fragment, or overheard plans that reveal the existence and location of a cave being used as a holding site.
- Rewards: Valuable intelligence about enemy operations, potential leverage for future negotiations, and the respect of Lieutenant Crownguard for uncovering a deeper plot.
...
Armed with intelligence about the cave and the fate of the missing villagers, the party must decide whether to mount an immediate rescue or report back to the outpost. Their actions here set up the next phase: a tense mountain pursuit and cave exploration, with both time and enemy agents working against them.