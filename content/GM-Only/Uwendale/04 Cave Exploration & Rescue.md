...
- Primary: Explore the cave, defeat or bypass enemy guards, and rescue the captives alive.
- Secondary: Gather intelligence on enemy plans; avoid or mitigate cave hazards; escape before reinforcements or a wyvern returns.

## Key NPCs & Creatures

- Noxian or Freljordian agents: Alerted to the party’s presence, ready to fight or bargain.
- Captured villagers: Some are held in a guarded chamber, others may be injured or hidden.
- Possible wild threats: A cave-dwelling beast (e.g., a juvenile wyvern or territorial predator) complicates the rescue.
...
- Stealth/Infiltration: Avoiding patrols or setting up ambushes.
- Combat: Facing enemy guards, possibly while protecting or freeing captives.
- Environmental hazards: Collapsing ceilings, slippery ledges, or sudden floods.
- Rescue challenge: Releasing captives from locked cells or bindings under pressure.

## Clues & Rewards

- Clues: Enemy documents, maps, or overheard plans reveal the broader plot or future threats to Uwendale.
- Rewards: Rescued villagers may provide vital information, gratitude, or healing; enemy gear or supplies can be salvaged.
- Tactical advantage: Successfully freeing the captives may allow them to assist in the escape or defence.
