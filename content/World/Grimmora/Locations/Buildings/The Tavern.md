...
The Tavern is an inn located in [[Mightrest]], run by the half-orc proprietor, [[Gorg]]. It features rooms for lodging upstairs and a kitchen where the [[Gnome Cook]] works.

## Features

### Recording Orbs

The tavern is equipped with crystal orbs that can record and replay events. Double-tapping an orb activates its playback function, as demonstrated by [[Gorg]] after a fight between [[Temerity]] and the gnome cook.
