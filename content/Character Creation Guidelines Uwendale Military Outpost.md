# Character Creation Guidelines: Uwendale Military Outpost

Welcome to Uwendale, a remote mountain village on Demacia's northeastern frontier. As new military recruits stationed at this outpost, you've completed basic training and earned your place as protectors of the realm. Before creating your character, please familiarize yourself with the following guidelines:

## Setting Context

Uwendale sits nestled among the Stonespine Peaks, far from the watchful eyes of Demacia's central authorities. The village serves primarily as a border outpost, providing early warning against threats from the wilder lands beyond. While Demacian law and culture firmly govern this settlement, the remote location means certain "practical compromises" occasionally occur.

## Military Role

All player characters are Level 3 recruits who have recently completed basic training. You've been assigned to this remote posting either as:

- Standard rotation duty for regular recruits
- A "proving assignment" for those showing exceptional promise
- A "second chance" posting for those who need to demonstrate their loyalty or discipline

## Character Class Options

**Encouraged Classes:**

- Fighter (all archetypes)
- Paladin (Oath of Devotion, Crown, or Conquest)
- Ranger (non-magical variants preferred)
- Rogue (especially Scout or Mastermind)
- Barbarian (tribal warriors from allied mountain clans)
- Cleric (of lawful deities, presenting powers as "divine blessing" rather than magic)

**Restricted Classes:**

- Wizard/Sorcerer/Warlock: Possible only with significant backstory justification. Your character must have methods to conceal their abilities and a compelling reason to risk serving in the military of a kingdom that would imprison or exile them.
- Druid/Bard: More tolerated than overt arcane casters, but still must practice discretely and have methods to explain or disguise magical abilities.

## Magic in Uwendale

**Important Context:**

- Demacia's core regions are rich in petricite, a stone that nullifies magic
- Uwendale, being in the mountains, has less petricite in the natural environment
- The military outpost contains petricite in its construction and some equipment
- All recruits wear small petricite emblems as part of their uniform

**For Magical Characters:**

- You must explain how you conceal your magical nature
- Options include: claiming divine blessing, disguising as "special techniques," having a secret identity, etc.
- Magical abilities should be used carefully and discreetly
- Consider how your character feels about serving an anti-magic kingdom

**For Non-Magical Characters:**

- Decide your attitude toward magic: fearful, hateful, indifferent, or secretly curious
- Consider whether you've had personal experiences with magic that shaped your view
...
- The Crownguard and Lightshield families are revered throughout the kingdom

## Character Bonds

Consider your relationship with:

- Your fellow recruits (the other PCs)
- Lieutenant Magnus Crownguard, your commanding officer
- The people of Uwendale
- The wider Demacian military
